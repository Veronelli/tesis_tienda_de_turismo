...
foreach ([HealthController::class, LoginController::class, AuthController::class, DestinoController::class, HotelController::class, ClienteController::class] as $controller) {
