...
function renderizarTabla(consultas) {
  ...
  tbody.innerHTML = consultas.map(c => {
    ...
    const creadoPor = c.creado_por ? formatearPersonaAuditoria(c.creado_por, 'Sin creador') : 'Sin creador';
...
function abrirModalConsulta(id) {
  ...
  document.getElementById('consultaCreadoPor').textContent = consulta.creado_por ? formatearPersonaAuditoria(consulta.creado_por, 'Sin creador') : 'Sin creador';
